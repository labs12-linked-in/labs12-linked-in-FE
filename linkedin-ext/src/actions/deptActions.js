...
export const getDept = () => async dispatch => {
  ...
  await axios
    .get(`${deployedDb}/api/departments/${localStorage.getItem("id")}`)
    .then(res => res.data)
    .then(depts => {
...
export const getIndivDept = deptId => dispatch => {
  ...
  axios
    .get(
      `${deployedDb}/api/departments/${localStorage.getItem("id")}/${deptId}`
    )
    .then(res => res.data)
    .then(department => {
...
export const deleteDept = (userId, deptId) => dispatch => {
  ...
  return axios
    .delete(`${deployedDb}/api/departments/${userId}/${deptId}`)
    .then(res => {
      // console.log(res);
